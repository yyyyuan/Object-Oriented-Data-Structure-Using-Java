...
public class CollectionBasedGraphTest {
	...
	public void testListVerticesContents() {
		...
		assertEquals(((Integer) 0), graph.listVertices().get(0));
		assertEquals(((Integer) 1), graph.listVertices().get(1));
		assertEquals(((Integer) 2), graph.listVertices().get(2));
		assertEquals(((Integer) 100), graph.listVertices().get(6));
		assertEquals(((Integer) 20), graph.listVertices().get(4));
		assertEquals(((Integer) 27), graph.listVertices().get(5));
		assertEquals(((Integer) 12), graph.listVertices().get(3));


	}
	
	@Test
	public void testListVerticesContents1() {
		graph.addVertex(100);
		graph.addVertex(12);
		graph.addVertex(2);
		graph.addVertex(1);
		...
		assertEquals(((Integer) 2), graph.listVertices().get(2));
		assertEquals(((Integer) 12), graph.listVertices().get(3));
		assertEquals(((Integer) 100), graph.listVertices().get(4));
	...
	public void testListNeighborsContents() {
		...
		assertTrue(graph.listNeighbors(1).contains(2));
